...
export default function Register() {
 ...
 async function register(value){
  ...
  let validationSchema = yup.object({
    ...
    password:yup.string().matches(/^[A-Z][a-z0-9]{5,10}$/, 'password is invalid, must start with capital letter and at least 5 characters long').required('password is required'),
    rePassword:yup.string().oneOf([yup.ref("password")], 'Password dont match').required('password is required'),
